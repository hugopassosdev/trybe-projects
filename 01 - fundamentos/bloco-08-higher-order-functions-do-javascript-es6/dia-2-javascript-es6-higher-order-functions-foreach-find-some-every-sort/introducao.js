...
// (6) Estrutura das HOFs em Arrays
...
// forEach: Função de objetos do tipo array e ela serve para que executamos um bloco de código para elemento do array. Já o array é um objeto que serve para armazenar outros objetos dentro dele em forma de lista.

// exemplo video:

// Enviar e-mail para todas as pessoas que passram no processo seletico da Trybe.
...
// o forEach espera receber uma função de no máximo três parâmetros:
// - parametro 1: nosso proprio item (obrigatorio);
// - parametro 2: posição do item no arrayOfValues;
// - parametro 3: propria lista que esta percorrendo;
